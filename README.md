...
With a webhook, every push to Github will be mirrored onto the OpenCPU server. You can access the app on http://terrabrasilis.dpi.inpe.br/ocpu/library/terrabrasilisTimeSeries/www/
